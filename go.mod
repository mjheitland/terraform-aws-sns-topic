module github.com/spglobal-innersource/terraform-aws-sns-topic

go 1.18

require github.com/GoogleCloudPlatform/cloud-foundation-toolkit/infra/blueprint-test v0.4.0
